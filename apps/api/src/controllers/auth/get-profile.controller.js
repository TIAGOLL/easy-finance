...
var GetProfileController = function () {
    var _classDecorators = [(0, common_1.Controller)('/sessions'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _handle_decorators;
    var GetProfileController = _classThis = /** @class */ (function () {
        function GetProfileController_1(prisma) {
            this.prisma = (__runInitializers(this, _instanceExtraInitializers), prisma);
        }
        GetProfileController_1.prototype.handle = function (user) {
        ...
        return GetProfileController_1;
    }());
    __setFunctionName(_classThis, "GetProfileController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _handle_decorators = [(0, common_1.Get)('get-profile')];
        ...
        GetProfileController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return GetProfileController = _classThis;
}();
