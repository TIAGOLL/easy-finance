...
var bodyValidationPipe = new zod_validation_pipe_1.ZodValidationPipe(CreateTaskSchema);
var CreateTaskController = function () {
    ...
    var CreateTaskController = _classThis = /** @class */ (function () {
        function CreateTaskController_1(prisma) {
            this.prisma = (__runInitializers(this, _instanceExtraInitializers), prisma);
        }
        CreateTaskController_1.prototype.handle = function (body, user) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [2 /*return*/, { message: 'A tarefa foi criada.' }];
                    }
                });
            });
        };
        return CreateTaskController_1;
    }());
    __setFunctionName(_classThis, "CreateTaskController");
    (function () {
        ...
        CreateTaskController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CreateTaskController = _classThis;
}();
