...
var FinishTaskBodySchema = zod_1.z.object({
    id: zod_1.z.string(),
});
var bodyValidationPipe = new zod_validation_pipe_1.ZodValidationPipe(FinishTaskBodySchema);
var FinishTaskController = function () {
    ...
    var FinishTaskController = _classThis = /** @class */ (function () {
        function FinishTaskController_1(prisma) {
            this.prisma = (__runInitializers(this, _instanceExtraInitializers), prisma);
        }
        FinishTaskController_1.prototype.handle = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [2 /*return*/, { message: 'A tarefa foi finalizada.' }];
                    }
                });
            });
        };
        return FinishTaskController_1;
    }());
    __setFunctionName(_classThis, "FinishTaskController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _handle_decorators = [(0, common_1.Patch)()];
        ...
        FinishTaskController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FinishTaskController = _classThis;
}();
